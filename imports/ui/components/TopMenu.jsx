...
const TopMenu = function ({ changeLanguage }) {
    ...
    return (
        <>
            ...
            <Modal title={t("post.new_post")} visible={isModalVisible} footer={null} onCancel={handleCancel}>
                <Form
                    form={form}
                    {...layout}
                    name="new_post"
                ...
                >
                    ...
                    <Form.Item label={t("post.gallery")} name="post_images" rules={[{ required: true }]}>
                        <Upload
